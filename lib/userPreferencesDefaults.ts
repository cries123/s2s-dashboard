...
export function getRoleAwareDefaults(role?: Role | UserRole): UserPreferences {
  const isManager = role === 'admin' || role === 'Manager' || role === 'manager';
  return {
    ...DEFAULT_PREFERENCES,
    dashboardModules: {
...
export type DeepPartialUserPreferences = {
...
export function mergeUserPreferences(
  stored: DeepPartialUserPreferences | undefined,
  role?: Role | UserRole
): UserPreferences {
