  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800/80 focus:border-indigo-400/50 outline-none rounded-lg px-3 py-2.5 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-700 transition-all focus:ring-2 focus:ring-indigo-500/15 font-semibold"
          />
        </div>
        <div className="space-y-1.5">
      ...
      {customerLastName.trim().length > 0 && matchCandidates.length > 0 && !selectedCustomer && (
        <div className="rounded-xl border border-slate-200 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-950/50 overflow-hidden">
          <p className="text-[8px] font-black uppercase tracking-widest text-slate-600 px-3 py-1.5 border-b border-slate-200 dark:border-slate-800/60">
            CRM matches <span className="text-slate-500 font-bold normal-case tracking-normal">(optional)</span>
          </p>
          <p className="text-[9px] text-slate-500 px-3 py-1.5 border-b border-slate-200 dark:border-slate-800/40">
          ...
          <div className="max-h-28 overflow-y-auto no-scrollbar p-1.5 space-y-1">
            {matchCandidates.slice(0, 6).map((cust) => (
              <button
                ...
                className="w-full text-left px-3 py-2 rounded-lg text-[10px] border border-transparent bg-white dark:bg-slate-900/60 text-slate-600 dark:text-slate-300 hover:bg-indigo-950/40 hover:border-indigo-500/30 transition-all"
              >
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          rows={2}
          className="w-full bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800/80 focus:border-indigo-400/50 outline-none rounded-lg px-3 py-2.5 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-700 transition-all focus:ring-2 focus:ring-indigo-500/15 font-medium resize-y min-h-[4.5rem]"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="w-full bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800/80 focus:border-indigo-400/50 outline-none rounded-lg px-3 py-2.5 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-700 transition-all focus:ring-2 focus:ring-indigo-500/15 font-mono font-bold uppercase tracking-wider"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <select
          ...
          className="w-full bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800/80 focus:border-indigo-400/50 outline-none rounded-lg px-3 py-2.5 text-sm text-slate-900 dark:text-white transition-all focus:ring-2 focus:ring-indigo-500/15 font-semibold"
          required
        >
          ...
          <div className="flex flex-wrap items-center gap-1.5 mb-2">
            ...
            {PROMISE_PRESETS.map((preset) => (
              <button
                ...
                className="px-2.5 py-1 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-950/80 text-[9px] font-black uppercase text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:border-indigo-500/40 transition-colors"
              >
                {preset.label}
              </button>
            ))}
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full appearance-none bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800/80 focus:border-indigo-400/50 outline-none rounded-lg pl-7 pr-8 py-2.5 text-[11px] text-slate-700 dark:text-slate-200 font-bold uppercase tracking-wide cursor-pointer focus:ring-2 focus:ring-indigo-500/15"
          >
      ...
      <div className="flex flex-wrap items-center gap-4 pt-3 border-t border-slate-200 dark:border-white/[0.06]">
        <label className="flex items-center gap-2.5 cursor-pointer group">
          <input
            ...
            className="rounded border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-rose-500 focus:ring-rose-500/30 w-4 h-4 cursor-pointer"
          />
          <span className="text-[10px] text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300 font-semibold transition-colors">
            Waiting
          </span>
        </label>
        <label className="flex items-center gap-2.5 cursor-pointer group">
          <input
            ...
            className="rounded border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-emerald-500 focus:ring-emerald-500/30 w-4 h-4 cursor-pointer"
          />
          <span className="text-[10px] text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300 font-semibold transition-colors">
            PDL
          </span>
        ...
        <button
          type="submit"
          disabled={submitting}
          className="ml-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider text-white bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-400 hover:to-violet-500 disabled:from-slate-300 dark:disabled:from-slate-800 disabled:to-slate-300 dark:disabled:to-slate-800 disabled:text-slate-500 dark:disabled:text-slate-600 shadow-lg shadow-indigo-950/40 transition-all duration-200"
        >
...
export function DispatchIntakePanel({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-slate-200 dark:border-white/[0.08] bg-gradient-to-br from-slate-50 via-white to-indigo-50 dark:from-slate-900/90 dark:via-slate-950 dark:to-indigo-950/30 shadow-xl shadow-black/5 dark:shadow-black/20">
      ...
      <div className="relative p-5 sm:p-6 flex flex-col gap-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-[11px] font-black text-slate-900 dark:text-white uppercase tracking-[0.2em]">Fast Intake</h2>
