...
export default function ServiceAlerts({
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-24 md:pb-8">
      <div className="sticky top-[4.25rem] z-30 -mx-4 px-4 py-3 sm:static sm:mx-0 sm:px-0 sm:py-0 bg-surface-base/95 sm:bg-transparent backdrop-blur-md sm:backdrop-blur-none border-b border-slate-200 dark:border-white/5 sm:border-0">
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white flex flex-wrap items-center gap-2 sm:gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-4 sm:gap-6">
        {activeAlerts.length === 0 ? (
          <div className="md:col-span-2 card-base p-10 sm:p-12 text-center border-dashed border-slate-300 dark:border-slate-700 bg-transparent">
            <div className="w-16 h-16 bg-slate-200 dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4 text-emerald-400">
              <History size={32} />
            </div>
