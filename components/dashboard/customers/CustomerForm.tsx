...
export default function CustomerForm({ currentUser, onSuccess, onError }: CustomerFormProps) {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    if ((id === 'phone' || id === 'email') && contactError) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.phone.trim() && !formData.email.trim()) {
      setContactError('Enter at least a phone number or an email address so this customer can be reached.');
      return;
    }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-0 lg:px-6">
        ...
        <button
          ...
          className={`w-full sm:w-auto flex items-center justify-center gap-2.5 py-4 px-8 rounded-2xl text-xs font-black uppercase tracking-wider border transition-all duration-200 ${
            showAIScanner 
              ...
              : 'bg-slate-900/5 dark:bg-white/5 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10 hover:bg-slate-100 dark:hover:bg-[#0c1020]'
          }`}
        >
          <Camera size={15} />
            ...
            >
              <div
                ...
                className={`relative p-8 rounded-3xl border-2 border-dashed transition-all duration-300 flex flex-col items-center justify-center text-center group ${
                  dragActive ? 'border-brand-primary bg-brand-primary/5' : 'border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20 bg-white dark:bg-[#0a0e1a]/80'
                }`}
              >
                <div className={`p-4 rounded-full mb-4 transition-all ${dragActive ? 'bg-brand-primary/10 text-brand-primary' : 'bg-slate-900/5 dark:bg-white/5 text-slate-400 group-hover:bg-slate-900/10 dark:group-hover:bg-white/10 group-hover:text-brand-primary'}`}>
                  {isProcessing ? (
                ...
                <h5 className="text-xs font-black uppercase tracking-widest text-slate-900 dark:text-slate-200">Form Scanner</h5>
      ...
      <div className="max-w-4xl mx-auto">
        <form onSubmit={handleSubmit} className="relative rounded-3xl bg-white dark:bg-[#0a0e1a] border border-slate-200 dark:border-white/5 shadow-2xl p-6 md:p-8 space-y-8 overflow-hidden">
          ...
          <div className="border-b border-slate-200 dark:border-white/5 pb-6">
            <h2 className="text-lg font-black uppercase tracking-wider text-slate-900 dark:text-slate-200 flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-100 dark:bg-[#0e1324] border border-slate-200 dark:border-white/5 focus:border-brand-primary/50 text-slate-900 dark:text-slate-200 px-3.5 py-3 rounded-xl text-xs font-semibold focus:outline-none placeholder:text-slate-600 transition-all duration-150"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-100 dark:bg-[#0e1324] border border-slate-200 dark:border-white/5 focus:border-brand-primary/50 text-slate-900 dark:text-slate-200 pl-12 pr-3.5 py-3 rounded-xl text-xs font-semibold focus:outline-none placeholder:text-slate-600 transition-all duration-150 font-mono"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-100 dark:bg-[#0e1324] border border-slate-200 dark:border-white/5 focus:border-brand-primary/50 text-slate-900 dark:text-slate-200 pl-12 pr-3.5 py-3 rounded-xl text-xs font-semibold focus:outline-none placeholder:text-slate-600 transition-all duration-150"
              ...
              {contactError && (
                <div className="sm:col-span-2 flex items-start gap-2 px-1">
                  ...
                  <p className="text-[10px] font-bold text-rose-400 uppercase tracking-wide">{contactError}</p>
                </div>
              )}
              ...
              <div className="space-y-1.5 sm:col-span-2">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-100 dark:bg-[#0e1324] border border-slate-200 dark:border-white/5 focus:border-brand-primary/50 text-slate-900 dark:text-slate-200 pl-12 pr-3.5 py-3 rounded-xl text-xs font-extrabold uppercase tracking-wider focus:outline-none transition-all duration-150 appearance-none cursor-pointer"
                  >
              ...
              <div className="sm:col-span-2 space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    maxLength={17}
                    className="w-full bg-slate-100 dark:bg-[#0e1324] border border-slate-200 dark:border-white/5 focus:border-brand-primary/50 text-slate-900 dark:text-slate-200 pl-12 pr-12 py-3 rounded-xl text-xs font-black uppercase tracking-wider focus:outline-none placeholder:text-slate-600 transition-all duration-150 font-mono"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    maxLength={8}
                    className="w-full bg-slate-100 dark:bg-[#0e1324] border border-slate-200 dark:border-white/5 focus:border-brand-primary/50 text-slate-900 dark:text-slate-200 pl-12 pr-3.5 py-3 rounded-xl text-xs font-black uppercase tracking-wider focus:outline-none placeholder:text-slate-600 transition-all duration-150 font-mono"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-100 dark:bg-[#0e1324] border border-slate-200 dark:border-white/5 focus:border-brand-primary/50 text-slate-900 dark:text-slate-200 pl-12 pr-3.5 py-3 rounded-xl text-xs font-black uppercase tracking-wider focus:outline-none transition-all duration-150 appearance-none"
                  />
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full bg-slate-100 dark:bg-[#0e1324] border border-slate-200 dark:border-white/5 focus:border-brand-primary/50 text-slate-900 dark:text-slate-200 p-4 rounded-xl text-xs font-semibold focus:outline-none placeholder:text-slate-600 transition-all duration-150 h-24 resize-none"
          ...
          <div className="pt-6 border-t border-slate-200 dark:border-white/5 flex flex-col sm:flex-row justify-between items-center gap-6">
            <label className="flex items-center gap-3 cursor-pointer group w-full sm:w-auto">
              <div className="relative flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  className="peer h-5 w-5 bg-slate-100 dark:bg-slate-900 border-slate-300 dark:border-white/10 rounded-md text-brand-primary focus:ring-offset-white dark:focus:ring-offset-slate-900 transition-all"
                />
              </div>
              <div className="text-left">
                <span className="text-xs font-black uppercase text-slate-600 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-white transition-colors block">Auto-Enroll Alerts</span>
