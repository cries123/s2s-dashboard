    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 lg:p-10">
        ...
        <motion.div
          ...
          className="relative w-full max-w-6xl max-h-[90vh] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col"
        ...
        >
          ...
          <div className="p-8 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-900/50">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight italic">Manual Productivity <span className="text-brand-primary">Input</span></h2>
            ...
            <button
              onClick={onClose}
              className="p-3 hover:bg-slate-900/5 dark:hover:bg-white/5 rounded-2xl transition-colors text-slate-500 hover:text-slate-900 dark:hover:text-white"
            >
              <X size={24} />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
            <form id="manual-entry-form" onSubmit={handleSubmit} className="space-y-6">
              {advisors.map((advisor, index) => (
                <div key={index} className="p-6 bg-slate-100 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-3xl relative group">
                  <div className="absolute -top-3 left-6 px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-[9px] font-black text-brand-primary uppercase tracking-widest">
                    Advisor #{index + 1}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6 mt-2">
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-700 focus:border-brand-primary/50 transition-colors"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 dark:text-white focus:border-brand-primary/50 transition-colors"
                      />
                    </div>
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 flex flex-col justify-center">
                       <p className="text-[8px] font-black text-slate-600 uppercase tracking-widest mb-1">Total Sales</p>
                       <p className="text-sm font-black text-slate-900 dark:text-white">${advisor.totalSales?.toLocaleString()}</p>
                    </div>
            ...
            <button
              ...
              className="w-full py-4 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-3xl text-slate-500 hover:text-brand-primary hover:border-brand-primary/50 hover:bg-brand-primary/5 transition-all text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2"
            >
              <Plus size={16} />
          ...
          {/* Footer */}
          <div className="p-8 border-t border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-950/50 flex items-center justify-between">
            ...
            <div className="flex gap-4">
              <button
                type="button"
                onClick={onClose}
                className="px-8 py-4 bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-white rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-slate-300 dark:hover:bg-slate-700 transition-colors"
              >
                Cancel
              </button>
              <button
