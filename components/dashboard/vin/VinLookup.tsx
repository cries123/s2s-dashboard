    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="relative">
        ...
        <header className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight uppercase">VIN Intelligence</h2>
          </div>
        ...
        <div className="mt-8 group relative">
          ...
          <form onSubmit={handleSearch} className="relative flex flex-col md:flex-row gap-0 bg-white dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200 dark:border-white/5 rounded-[2rem] overflow-hidden shadow-2xl p-1.5 focus-within:border-brand-primary/30 transition-all">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-transparent border-none focus:ring-0 focus:outline-none py-6 pl-16 pr-6 text-xl font-black text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600 tracking-[0.25em] uppercase font-mono"
                maxLength={17}
              />
            </div>
            <button 
      ...
      {data && !error && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 stagger-fade-in">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="relative overflow-hidden group rounded-[2.5rem] bg-white dark:bg-slate-950/40 border border-slate-200 dark:border-white/5 backdrop-blur-3xl shadow-2xl">
              ...
              <div className="relative p-10 flex flex-col md:flex-row items-center gap-10">
                <div className="flex-1 space-y-4">
                  ...
                  <h3 className="text-5xl font-black text-slate-900 dark:text-white leading-[1.1] tracking-tighter uppercase italic">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-slate-400 font-mono text-sm tracking-widest font-bold">
                    <div className="flex items-center gap-2 bg-slate-900/5 dark:bg-white/5 py-1.5 px-4 rounded-xl border border-slate-900/5 dark:border-white/5">
                      <span className="text-slate-500">VIN</span>
                      <span className="text-slate-900 dark:text-white">{vin}</span>
                    </div>
                    {data.find(r => r.Variable === "Series")?.Value && (
                      <span className="text-xs uppercase bg-slate-900/5 dark:bg-white/5 py-1.5 px-4 rounded-xl border border-slate-900/5 dark:border-white/5">
                ...
                <div className="relative flex-1 flex justify-center items-center py-6">
                  ...
                  <Car className="text-slate-900/5 dark:text-white/5 group-hover:text-brand-primary/20 transition-colors w-48 h-48 lg:w-64 lg:h-64 absolute -bottom-10 -right-10 pointer-events-none rotate-12" />
                  <div className="relative z-10 w-full flex justify-center">
                    <div className="p-12 bg-slate-900/5 dark:bg-white/5 backdrop-blur-sm rounded-[3rem] border border-slate-900/10 dark:border-white/10 shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               ...
               <div className="flex items-center gap-4 p-6 bg-white dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200 dark:border-white/5 rounded-3xl">
                  <div className="w-12 h-12 bg-brand-primary/20 rounded-2xl flex items-center justify-center text-brand-primary">
                    <BadgeCheck size={24} />
                  </div>
                  <div>
                    <h4 className="text-lg font-black text-slate-900 dark:text-white leading-none">VALID VIN</h4>
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Market Sidepiece */}
            <div className="p-8 bg-white dark:bg-slate-950/40 backdrop-blur-2xl border border-slate-200 dark:border-white/5 rounded-[2rem] shadow-2xl flex flex-col h-full">
              <div className="flex items-center justify-between mb-8">
                ...
                {marketValue?.marketTrend && (
                  <div className={cn(
                    ...
                    marketValue.marketTrend === 'Rising' ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-500" : "bg-slate-500/10 border-slate-300 dark:border-white/10 text-slate-500"
                  )}>
                    {marketValue.marketTrend}
                  </div>
                )}
              ...
              <div className="flex-1 space-y-8">
                {isValuing ? (
                  <div className="space-y-4 animate-pulse">
                    <div className="h-10 bg-slate-200 dark:bg-white/5 rounded-2xl w-full" />
                    <div className="h-32 bg-slate-200 dark:bg-white/5 rounded-3xl w-full" />
                  </div>
                ) : marketValue ? (
                  <>
                    <div>
                      ...
                      <div className="flex items-baseline gap-1">
                        <span className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">${(marketValue.tradeInLow / 1000).toFixed(1)}k</span>
                    ...
                    <div className="bg-brand-primary/5 border border-brand-primary/10 p-5 rounded-[2rem] relative overflow-hidden group">
                      ...
                      <p className="text-xs text-slate-600 dark:text-slate-300 font-medium leading-relaxed italic">"{marketValue.advisorTip}"</p>
                    </div>

                    <div className="space-y-3">
                      <div className="flex justify-between items-center text-[10px] font-bold">
                        <span className="text-slate-500 uppercase tracking-widest">Private Party</span>
                        <span className="text-slate-900 dark:text-white">${(marketValue.privatePartyLow / 1000).toFixed(1)}k - ${(marketValue.privatePartyHigh / 1000).toFixed(1)}k</span>
                      </div>
          ...
          <div className="lg:col-span-6 space-y-6">
                   ...
                   <div className="p-8 bg-rose-950/20 border border-rose-500/20 rounded-[2.5rem] mb-6 backdrop-blur-xl">
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {recalls.map((recall, i) => (
                           <div key={i} className="p-8 bg-white dark:bg-black/40 border border-slate-200 dark:border-white/5 rounded-3xl shadow-2xl">
                             ...
                             <h5 className="text-xl font-bold text-slate-900 dark:text-white mb-3 leading-tight underline decoration-rose-500/30 underline-offset-4">{recall.Component}</h5>
                             <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed mb-8">{recall.Summary}</p>
                             <div className="p-6 bg-rose-500/5 border border-rose-500/10 rounded-[1.5rem]">
                                ...
                                <p className="text-sm text-slate-600 dark:text-slate-300 font-medium leading-relaxed italic">"{recall.Remedy}"</p>
                             </div>
                           </div>
                        ))}
                     </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Efficiency Panel */}
              <div className="p-8 bg-white dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200 dark:border-white/5 rounded-[2.5rem] shadow-2xl">
                <div className="flex items-center justify-between mb-8">
                   <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">Propulsion Metrics</h4>
                ...
                {fuelData ? (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="p-6 bg-slate-100 dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/5 group hover:border-amber-500/20 transition-colors">
                      <p className="text-[9px] font-black text-slate-500 uppercase mb-2 tracking-widest">City Cycle</p>
                      <p className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">{fuelData.city08}<span className="text-sm ml-1 text-slate-600 font-bold">MPG</span></p>
                    </div>
                    <div className="p-6 bg-slate-100 dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/5 group hover:border-amber-500/20 transition-colors">
                      <p className="text-[9px] font-black text-slate-500 uppercase mb-2 tracking-widest">Highway</p>
                      <p className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">{fuelData.highway08}<span className="text-sm ml-1 text-slate-600 font-bold">MPG</span></p>
                    </div>
                    <div className="p-6 bg-amber-500/10 rounded-3xl border border-amber-500/20 ring-4 ring-amber-500/5 flex flex-col justify-center">
                       ...
                       <p className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">{fuelData.comb08}<span className="text-xs ml-1 text-amber-500 font-black">AVG</span></p>
                    </div>
                  </div>
                ) : (
                ...
                <div className="p-8 bg-white dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200 dark:border-white/5 rounded-[2.5rem] shadow-2xl">
                   <div className="flex items-center justify-between mb-8">
                     <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">Model Heritage</h4>
                          <p className="text-[9px] font-bold text-slate-500 uppercase mt-0.5">Historical Platform Recalls</p>
                        </div>
                     </div>
                     <div className="px-4 py-2 bg-slate-100 dark:bg-slate-950/50 rounded-2xl border border-slate-200 dark:border-white/5">
                        <span className="text-xl font-black text-slate-900 dark:text-white font-mono">{modelRecalls.length}</span>
                     </div>
                  </div>

                  <div className="space-y-3 max-h-[160px] overflow-y-auto pr-2 custom-scrollbar">
                     {modelRecalls.slice(0, 5).map((r, i) => (
                        <div key={i} className="flex justify-between items-center p-3 bg-slate-100 dark:bg-white/5 rounded-xl border border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10 transition-colors">
                           <div className="flex-1 overflow-hidden">
                              <p className="text-[10px] font-black text-slate-600 dark:text-slate-300 truncate tracking-tight">{r.Component}</p>
                  ...
                  <button 
                    ...
                    className="w-full mt-6 py-4 bg-slate-100 dark:bg-slate-950/50 border border-slate-200 dark:border-white/5 rounded-2xl text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-[0.2em] hover:bg-slate-200 dark:hover:bg-slate-950 transition-colors"
                  >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
              {data.map((item, idx) => (
                <motion.div 
                  ...
                  key={idx} 
                  className="p-5 bg-white dark:bg-slate-950/20 backdrop-blur-xl border border-slate-200 dark:border-white/5 rounded-2xl group hover:border-brand-primary/20 hover:bg-brand-primary/5 transition-all"
                >
      ...
      {!data && !loading && (
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="relative min-h-[500px] flex flex-col items-center justify-center p-20 rounded-[3rem] border border-dashed border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-slate-900/10 overflow-hidden group"
        >
          ...
          <div className="relative p-12 bg-white dark:bg-slate-950 rounded-[2.5rem] border border-slate-200 dark:border-white/5 shadow-2sl mb-8 transform group-hover:-translate-y-2 transition-transform duration-500">
             <Car size={80} strokeWidth={1} className="text-slate-800" />
          </div>
          
          <div className="text-center space-y-3 relative z-10">
            <h3 className="text-2xl font-black text-slate-900 dark:text-white tracking-widest uppercase italic">Diagnostic Terminal Alpha</h3>
        ...
        {modelRecallsExpanded && modelRecalls && (
          ...
          >
            <motion.div 
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="w-full max-w-6xl max-h-[80vh] bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-[3rem] shadow-2xl overflow-hidden flex flex-col"
              onClick={e => e.stopPropagation()}
            >
              <div className="p-10 border-b border-slate-200 dark:border-white/5 flex items-center justify-between">
                <div>
                   <h3 className="text-3xl font-black text-slate-900 dark:text-white tracking-tighter uppercase italic">Platform Recall History</h3>
                ...
                <button onClick={() => setModelRecallsExpanded(false)} className="p-4 bg-slate-900/5 dark:bg-white/5 hover:bg-slate-900/10 dark:hover:bg-white/10 rounded-2xl transition-colors">
              ...
              <div className="flex-1 overflow-y-auto p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 custom-scrollbar">
                {modelRecalls.map((recall, i) => (
                  <div key={i} className="p-8 bg-white dark:bg-slate-950/50 border border-slate-200 dark:border-white/5 rounded-3xl hover:border-brand-primary/20 transition-all group">
                     <div className="flex justify-between items-start mb-6">
                     ...
                     <h5 className="text-base font-bold text-slate-900 dark:text-white mb-3 group-hover:text-brand-primary transition-colors leading-tight">{recall.Component}</h5>
                     <p className="text-xs text-slate-500 leading-relaxed font-medium line-clamp-4 italic">"{recall.Summary}"</p>
                  </div>
                ))}
              </div>
              
              <div className="p-6 bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-white/5 text-center">
