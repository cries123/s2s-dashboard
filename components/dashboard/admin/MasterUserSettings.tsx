  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="border-b border-slate-200 dark:border-white/5 pb-4">
        ...
        <p className="text-xs mt-2 max-w-2xl" style={{ color: 'var(--color-text-secondary)' }}>
          {managerMode
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        {!scopeTenantId ? (
          <select
            ...
            className="input-field px-3 py-2.5 text-xs font-bold min-w-[200px]"
          >
        ...
        <div
          className="text-[10px] font-black uppercase tracking-widest flex items-center px-2"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-2 card-base border border-slate-200 dark:border-white/5 overflow-hidden flex flex-col lg:max-h-[640px]">
          <div className="lg:overflow-y-auto divide-y divide-slate-200 dark:divide-slate-800">
            {filteredUsers.map((u) => (
              <button
                key={u.uid}
                type="button"
                ...
                className={cn(
                  'w-full text-left p-4 hover:bg-slate-100 dark:hover:bg-slate-900/50 transition-colors',
                  selectedUid === u.uid && 'bg-brand-primary/10 border-l-2 border-brand-primary'
                )}
              >
                <div className="flex justify-between gap-2">
                  <div className="min-w-0">
                    <p className="text-sm font-black text-slate-900 dark:text-white truncate">{u.username}</p>
                ...
                <div className="flex gap-2 mt-2 flex-wrap">
                  ...
                  <span className="text-[8px] font-black uppercase" style={{ color: 'var(--color-text-tertiary)' }}>
        ...
        <div className="lg:col-span-3 card-base border border-slate-200 dark:border-white/5 p-6 space-y-5">
          {!selectedUser ? (
            ...
            <>
              <div className="flex items-start justify-between gap-4 border-b border-slate-200 dark:border-white/5 pb-4">
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white uppercase">{selectedUser.username}</h3>
                  <p className="text-[10px] font-mono mt-1" style={{ color: 'var(--color-text-tertiary)' }}>{selectedUser.uid}</p>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {!managerMode ? (
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <p className="text-sm font-mono" style={{ color: 'var(--color-text-secondary)' }}>{selectedUser.email || '—'}</p>
                  </div>
                )}
                {!managerMode ? (
                  <div className="sm:col-span-2">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                ...
                {!managerMode || canModifyUser(currentUser, selectedUser) ? (
                  <button
                    ...
                    className="px-4 py-2 text-[10px] font-black uppercase rounded-xl bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 flex items-center gap-2"
                  >
                    <RefreshCw size={14} />
                    Send reset email
                  </button>
