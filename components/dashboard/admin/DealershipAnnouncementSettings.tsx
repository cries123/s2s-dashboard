  ...
  return (
    <div className="space-y-3 rounded-2xl border border-amber-500/20 bg-amber-950/10 p-4">
      ...
      <textarea
        ...
        className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2.5 text-sm text-slate-900 dark:text-white placeholder:text-slate-500 dark:placeholder:text-slate-600 resize-y min-h-[4.5rem] focus:outline-none focus:ring-2 focus:ring-amber-500/25"
      />
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          onClick={clear}
          disabled={saving}
          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl border border-slate-300 dark:border-slate-700 text-[10px] font-black uppercase tracking-wider text-slate-500 dark:text-slate-400 hover:text-rose-300 hover:border-rose-900/40 transition-colors"
        >
          <Trash2 size={12} />
          Clear
        </button>
