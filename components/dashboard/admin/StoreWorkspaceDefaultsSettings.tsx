      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-2xl">
        <div>
          ...
          <input
            ...
            className="w-full mt-1 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-black text-slate-900 dark:text-white"
          />
        </div>
        <div>
          ...
          <select
            ...
            className="w-full mt-1 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-bold text-slate-900 dark:text-white"
          >
