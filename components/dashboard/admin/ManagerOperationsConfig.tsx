...
function Toggle({
  ...
  return (
    <label className="flex items-center justify-between p-3 bg-slate-100 dark:bg-slate-950/80 rounded-xl border border-white/5 cursor-pointer">
      <div className="pr-2">
        <span className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-wide block">{label}</span>
      ...
      >
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          {[
            ...
            <div key={tile.label} className="rounded-xl border border-white/5 bg-slate-50 dark:bg-slate-950/60 p-3">
              <p className="text-[9px] font-black uppercase text-slate-500">{tile.label}</p>
              <p className="text-lg font-black text-slate-900 dark:text-white tabular-nums mt-1">{tile.value}</p>
            </div>
          ))}
        </div>
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {(orderedLanes as { id: DispatchProductionLane; label: string }[]).map((lane) => {
              ...
              return (
                <span
                  key={lane.id}
                  className="text-[10px] font-bold px-2 py-1 rounded-lg bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-600 dark:text-slate-300"
                >
                  {label}: {avg}m avg
                </span>
              );
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-2xl">
          <div>
            ...
            <input
              ...
              className="w-full mt-1 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-black text-slate-900 dark:text-white"
            />
          </div>
          <div>
        ...
        <div className="flex flex-wrap gap-2 mt-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 text-[10px] font-black uppercase"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-300 dark:border-slate-700 text-[10px] font-black uppercase disabled:opacity-40"
          >
            <RotateCcw size={12} />
              ...
              <button
                ...
                className={cn(
                  ...
                  selected
                    ...
                    : 'border-white/5 bg-slate-50 dark:bg-slate-950/80 hover:border-slate-300 dark:hover:border-slate-700'
                )}
              >
                <span className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-wide block">
                  {option.title}
                </span>
      ...
      >
        <div className="max-w-xs">
          ...
          <select
            ...
            className="w-full mt-1 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-bold text-slate-900 dark:text-white"
          >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    on
                      ...
                      : 'border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-900 text-slate-500'
                  )}
                >
                  {a.label}
                </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-2xl">
          ...
          <div>
            ...
            <input
              ...
              className="w-full mt-1 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs text-slate-900 dark:text-white"
            />
          </div>
          <div>
            ...
            <input
              ...
              className="w-full mt-1 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-mono text-slate-900 dark:text-white"
            />
          </div>
          <div>
          ...
          {orderedLanes.map((lane, idx) => (
            <div key={lane.id} className="flex gap-2 items-center">
              ...
              <input
                ...
                className="flex-1 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-bold text-slate-900 dark:text-white"
              />
            </div>
          ))}
        </div>
      ...
      >
        <div className="max-w-xs">
          <select
            ...
            className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-bold text-slate-900 dark:text-white"
          >
