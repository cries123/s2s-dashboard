  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative w-32 h-32 mb-12">
          ...
          >
            <div className="flex flex-col items-center">
              <span className="text-4xl font-black italic tracking-tighter leading-none" style={{ color: 'var(--color-text-primary)' }}>S2S</span>
        ...
        <div className="text-center space-y-4">
          <motion.h2 
            ...
            className="text-base font-black uppercase tracking-[0.4em] italic"
      ...
      <div className="absolute bottom-12 left-0 w-full flex justify-center opacity-20">
        <div
          className="flex items-center gap-8 text-[8px] font-black uppercase tracking-[0.5em]"
          style={{ color: 'var(--color-text-secondary)' }}
        >
