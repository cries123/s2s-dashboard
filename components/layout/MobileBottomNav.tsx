...
export function MobileBottomNav({
  ...
  return (
    <>
      <AnimatePresence>
        {expanded && expanded.items.length > 1 && (
          <>
            ...
            >
              <div className="mx-auto max-w-lg rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/95 shadow-[0_-12px_40px_rgba(0,0,0,0.45)] backdrop-blur-xl overflow-hidden">
                <div className="px-4 py-3 border-b border-slate-200 dark:border-white/5 bg-slate-100 dark:bg-slate-800/50 flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={() => setExpandedSection(null)}
                    className="text-[9px] font-black uppercase tracking-wider text-slate-500 hover:text-slate-900 dark:hover:text-white px-2 py-1"
                  >
                    Close
                  </button>
                </div>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          isActive
                            ...
                            : 'text-slate-600 dark:text-slate-300 hover:bg-slate-900/5 dark:hover:bg-white/5 active:bg-slate-900/10 dark:active:bg-white/10'
                        )}
                      >
      ...
      <nav
        className="md:hidden fixed bottom-0 inset-x-0 z-[80] border-t border-slate-200 dark:border-white/10 bg-white dark:bg-slate-950/95 backdrop-blur-xl shadow-[0_-8px_30px_rgba(0,0,0,0.35)]"
