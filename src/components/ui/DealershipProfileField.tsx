    ...
    <div className={cn('space-y-1.5', className)}>
      ...
      {isAdmin ? (
        <select
          ...
          className="w-full bg-slate-950 border border-white/10 rounded-xl px-3 py-2.5 text-sm text-white focus:ring-1 focus:ring-brand-primary/40 outline-none"
        >
          {DEALERSHIPS.map((d) => (
        ...
        <div
          className="w-full bg-slate-950/80 border border-white/5 rounded-xl px-3 py-2.5 text-sm text-slate-300 flex items-center justify-between gap-2"
          aria-readonly
        >
